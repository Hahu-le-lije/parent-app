...
const ChildDetail = () => {
  ...
  const lastPurchasedPlan = useChildrenStore(
    (state) => state.lastPurchasedPlan,
  );
  ...
  const skills = [
    { label: "Reading", value: 82, color: "#078930" },
    { label: "Listening", value: 74, color: "#B58A00" },
    { label: "Speaking", value: 68, color: "#DA121A" },
    { label: "Writing", value: 90, color: "#FCD116" },
  ];
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
          ...
          {open && (
            <View style={styles.aiContent}>
              ...
              <Text style={styles.recommendation}>
                Suggestion:{"\n"}
                Focus more on {weakest.label.toLowerCase()} activities this
                week. Short 10–15 minute sessions combined with{" "}
                {strongest.label.toLowerCase()} tasks usually work best to keep{" "}
                {child?.name?.split(" ")[0] || "them"} motivated.
              </Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.streak}>
          ...
          <Text
            style={{ fontSize: 25, fontFamily: "Poppins-Bold", color: "white" }}
          >
            12
          </Text>
          <Text
        ...
        <View style={styles.weekContainer}>
          ...
          <Text style={styles.totalTime}>Total: {totalMinutes} minutes</Text>
