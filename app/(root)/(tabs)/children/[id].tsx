          ...
          {open && (
            <View style={styles.aiContent}>
              <Text style={styles.aiIntro}>
                Quick summary for {child?.firstname}
              </Text>
              <View style={styles.recommendationBox}>
                <Text style={styles.recommendationText}>
                  <Text
                    style={{ fontFamily: "Poppins-Bold", color: "#10B981" }}
                  >
                    Suggestion:{" "}
                  </Text>
                  Focus more on {weakest.label.toLowerCase()} activities. Short
                  10–15 min sessions with {strongest.label.toLowerCase()} tasks
                  work best.
                </Text>
              </View>
            </View>
                ...
                <View key={index} style={styles.barColumn}>
                  ...
                  <View
                    style={[
                      ...
                      {
                        height: barHeight + 20,
                        backgroundColor: index === 3 ? "#0286FF" : "#3E3E66",
                      },
                    ]}
                  />
